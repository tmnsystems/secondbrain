// Direct script to process a transcript without using the full agent system
// This simpler script should help avoid TypeScript errors
...
async function processTranscript() {
  try {
    ...
    const analysisResponse = await claude.invoke([
      { 
        role: 'user', 
    ...
    const styleResponse = await claude.invoke([
      { 
        role: 'user', 
