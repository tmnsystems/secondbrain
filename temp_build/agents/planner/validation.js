 ...
 */
function validatePlan({ analysis, tasks, timeline, specifications }) {
    const issues = [];
    const warnings = [];
    const suggestions = [];
 ...
 */
function validateTasksAgainstComponents(tasks, analysis, warnings, suggestions) {
 ...
 */
function validateTaskDependencies(tasks, issues, warnings) {
 ...
 */
function validateTimeline(timeline, tasks, issues, warnings, suggestions) {
    const taskIds = new Set(tasks.map(t => t.id));
    const timelinedTaskIds = new Set();
 ...
 */
function validateSpecifications(specifications, tasks, warnings, suggestions) {
