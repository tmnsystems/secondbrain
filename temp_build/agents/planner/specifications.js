...
async function createSpecifications(tasks, project) {
    ...
    for (const task of highPriorityTasks) {
        try {
            ...
            const specResult = await (0, claude_1.modelRequest)({
 ...
 */
function createSpecificationPrompt(task, allTasks, project) {
 ...
 */
function cleanSpecificationResponse(response) {
