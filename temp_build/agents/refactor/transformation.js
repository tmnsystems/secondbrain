...
exports.transformation = {
     ...
     */
    async applyRefactoring(files, pattern, config) {
        try {
     ...
     */
    async extractFunction(file, range, options, config) {
        try {
     ...
     */
    async renameSymbol(files, symbol, newName, config) {
        try {
     ...
     */
    async restructureClass(file, className, options, config) {
        try {
     ...
     */
    async normalizeCodeStyle(files, config) {
        try {
