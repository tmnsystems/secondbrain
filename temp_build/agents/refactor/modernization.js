...
exports.modernization = {
     ...
     */
    async modernizeCode(files, targetVersion, config) {
        try {
     ...
     */
    async migrateFramework(files, sourceFramework, targetFramework, config) {
        try {
     ...
     */
    async upgradeLanguageFeatures(files, targetVersion, config) {
        try {
     ...
     */
    async replaceDeprecatedAPIs(files, config) {
        try {
     ...
     */
    async improveBuildSystem(buildConfig, config) {
        try {
