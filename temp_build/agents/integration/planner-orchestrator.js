...
exports.PlannerOrchestratorIntegration = void 0;
/**
 ...
 */
class PlannerOrchestratorIntegration {
    /**
     ...
     */
    constructor(orchestrator, planner) {
     ...
     */
    async createWorkflowFromPlan(plan) {
        try {
     ...
     */
    async updateWorkflowBasedOnPlan(workflow, plan) {
        try {
     ...
     */
    async generateExecutionPlan(requirements) {
        try {
     ...
     */
    async optimizeWorkflowExecution(workflow) {
        try {
...
exports.PlannerOrchestratorIntegration = PlannerOrchestratorIntegration;
