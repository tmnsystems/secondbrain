 ...
 */
function createAnalysisPrompt(project: Project): string {
  return `
...
function parseAnalysisResponse(response: string): Analysis {
  try {
    ...
    const analysis: Analysis = {
      ...
      dependencies: (parsedAnalysis.dependencies || []).map((dep: any) => ({
        from: dep.from,
        to: dep.to,
        type: dep.type || 'hard',
        description: dep.description,
      })),
      risks: parsedAnalysis.risks ? (parsedAnalysis.risks || []).map((risk: any) => ({
