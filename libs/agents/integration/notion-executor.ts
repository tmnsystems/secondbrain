...
export interface NotionExecutorConfig {
  executionLogDatabaseId: string;
  deploymentsLogDatabaseId: string;
  systemMetricsDatabaseId: string;
}

export class NotionExecutorIntegration {
  private notion: NotionAgent;
  private executor: ExecutorAgent;
  private config: NotionExecutorConfig;
  
  constructor(
    notion: NotionAgent,
    executor: ExecutorAgent,
    config: NotionExecutorConfig
  ) {
    this.notion = notion;
   ...
   */
  async createDeploymentHistoryReport(project: string) {
    try {
...
export default NotionExecutorIntegration;