...
import { CodeAnalysisResult, RefactoringResult } from '../refactor/types';
 ...
 */
export class ReviewerRefactorIntegration {
   ...
   */
  constructor(reviewer: ReviewerAgent, refactor: RefactorAgent) {
   ...
   */
  async reviewRefactoring(changes: RefactoringResult) {
   ...
   */
  async suggestRefactorings(analysisResults: CodeAnalysisResult) {
   ...
   */
  async validateRefactoringImpact(changes: RefactoringResult) {
