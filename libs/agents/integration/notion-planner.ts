...
export interface NotionPlannerConfig {
  projectsDatabaseId: string;
  tasksDatabaseId: string;
  dependenciesDatabaseId: string;
}

export class NotionPlannerIntegration {
  private notion: NotionAgent;
  private planner: PlannerAgent;
  private config: NotionPlannerConfig;
  
  constructor(
    notion: NotionAgent,
    planner: PlannerAgent,
    config: NotionPlannerConfig
  ) {
    this.notion = notion;
   ...
   */
  async saveProjectPlan(project: any) {
    try {
   ...
   */
  async saveTask(task: any, projectId: string) {
    try {
   ...
   */
  async saveDependencies(taskId: string, dependencyIds: string[]) {
    try {
...
export default NotionPlannerIntegration;